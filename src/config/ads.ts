...
export const DIRECT_BANNERS: DirectBanner[] = [
  ...
  {
    id: "sber-inarticle-336x280",
    placement: "in-article",
    locales: ["ru"],
    href: "https://yknhc.com/g/snwhqwa37y1d9ff0ed903cdca90c0a/?i=4&erid=2bL9aMPo2e49hMef4rrTs6hYzc",
    image: "/ads/sber-336x280.jpg",
    alt: "СберЗдоровье — запись к врачу со скидкой 500 ₽ по промокоду",
    width: 336,
    height: 280,
    sponsored: true,
    mobileOnly: true,
    erid: "2bL9aMPo2e49hMef4rrTs6hYzc",
    advertiser: "СберЗдоровье (ДОКДОК)",
  },
  {
