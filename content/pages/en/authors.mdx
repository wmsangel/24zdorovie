...
Part of the preparatory work — literature search and organisation, draft structure, first versions of the text — is done with the help of language models. We say so openly. Nothing is published without manual verification: anything a model could not support with a primary source is removed. The author and the responsible party is always the editorial team, never the tool.
...
Write to hello@24zdorovie.com. The most useful message includes a link to the article, an exact quote of the disputed passage and, where possible, a link to the source that contradicts it.
