# GSC — очередь на принудительную индексацию (24zdorovie.com)

Ресурс: https://24zdorovie.com/ (URL-prefix). Лимит ~10 заявок/сутки.
Список собран из свежедобавленных страниц (GSC-отчёт «не проиндексировано» читать
через Claude in Chrome пока нельзя — google-домен заблокирован). Приоритет: самые
новые страницы под проверенные кластеры спроса → новые инструменты → перезалитые
хабы → остальное.

Правила: перед отправкой в «Проверка URL» смотреть статус; если «URL есть в индексе
...
- [ ] https://24zdorovie.com/ru/mental-health/kortizol-kak-snizit/
- [ ] https://24zdorovie.com/en/tools/one-rep-max-calculator/
...
- [ ] https://24zdorovie.com/ru/tools/blood-pressure-checker/
- [ ] https://24zdorovie.com/en/tools/blood-test-unit-converter/
- [ ] https://24zdorovie.com/ru/tools/blood-test-unit-converter/
- [ ] https://24zdorovie.com/ru/tools/bmi-calculator/ (перезаточен под «рассчитать ИМТ»)
- [ ] https://24zdorovie.com/en/tools/bmi-calculator/
- [ ] https://24zdorovie.com/ru/ (главная)
...
eye-health-vision, zdorove-polosti-rta / oral-health), питание (skolko-yaits-v-den /
eggs-per-day, rastitelnyy-i-zhivotnyy-belok / plant-vs-animal-protein), добавки
(ashvaganda / ashwagandha, kurkumin / curcumin-turmeric), сон (siniy-svet-i-son /
blue-light-and-sleep, dzhetlag / jet-lag), фитнес (progressiya-nagruzki /
progressive-overload, viit-trenirovki / hiit-training), вес (bezopasnyy-temp-pohudeniya /
safe-weight-loss-rate, chitmily-i-refidy / cheat-meals-refeeds), рецепты
(proteinovye-pankeyki / protein-pancakes, tofu-s-ovoshchami / tofu-veggie-stir-fry).
...
- 2026-09-25: слот зарезервирован за https://24zdorovie.com/en/fitness/hiit-training/ (GSC: «Обнаружена, не проиндексирована»); подать вручную.
